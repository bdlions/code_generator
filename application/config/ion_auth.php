...
*/
	...
	$config['admin_group']         = 'admin';
        $config['member_group']        = 'member';
        $config['demo_group']          = 'demo';
        
        $config['pagination_page_range']          = 50;
        
	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "Natural Language Processing";
	...
	/**
	 * New user will be under demo group
	 */
	$config['default_group']       = 'demo';
	...
	$config['error_end_delimiter'] = '</p>';
        ...
        /**
	 * Samply Dummy Password
	 **/
	$config['samply_dummy_password'] = '1Pas5s5wo0rD2';
